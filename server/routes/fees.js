...
router.get('/', protect, authorize('ADMIN', 'PRINCIPAL', 'ACCOUNTANT'), async (req, res) => {
  try {
...
router.post('/collect', protect, authorize('ADMIN', 'ACCOUNTANT'), async (req, res) => {
  try {
...
router.post('/generate', protect, authorize('ADMIN', 'ACCOUNTANT'), async (req, res) => {
  try {
